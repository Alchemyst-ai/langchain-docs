...
import AlchemystAiRetrieverExample from "/src/snippets/javascript-integrations/examples/retrievers/alchemystai.mdx";

<CodeBlock language="typescript">{AlchemystAiRetrieverExample}</CodeBlock>

## Support and Feedback
For more detailed docs, refer to the [**Alchemyst AI Docs**](https://docs.getalchemystai.com)
